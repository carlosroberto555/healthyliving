...
public class DataForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Alteração de Dados");
	...
	dispose();
	    ...
	    //Informações do usuário
            jTextField1.setText(userdata.getString("Nome"));
            jTextField2.setText(userdata.getString("Nascimento"));
            jTextField3.setText(userdata.getString("Telefone"));
	    jTextField4.setText(userdata.getString("Sexo"));
	    jTextField5.setText(userdata.getString("Peso"));
	    jTextField6.setText(userdata.getString("Altura"));
